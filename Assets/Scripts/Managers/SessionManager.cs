...
public class SessionManager : MonoBehaviour
{
    ...
    private readonly string url = "https://goedbeslissen.nl/session_request.php";
    ...
    public void Begin()
    {
        ...
        {
            StartCoroutine(JoinSessionRequest("?sessionCode=" + startScreenSessionCode.text));
        }
    }

    public void JoinSession(string sessionCode)
    {
        StartCoroutine(JoinSessionRequest("?sessionCode=" + sessionCode));
    }
    ...
    public void ResyncCurrentSession()
    {
        ...
        StartCoroutine(SyncCurrentSession("?sessionCode=" + currentSession.sessionCode));
    }
    ...
    IEnumerator SyncCurrentSession(string urlParameter)
    {
        UnityWebRequest request = UnityWebRequest.Get(url + urlParameter);
    ...
    IEnumerator JoinSessionRequest(string urlParameter)
    {
        UnityWebRequest request = UnityWebRequest.Get(url + urlParameter);
        request.SetRequestHeader("Content-Type", "application/json");
